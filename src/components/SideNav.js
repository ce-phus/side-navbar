...
const SideNav = () => {
  return (
    ...
    <div>
        ...
        <div className='px-3 py-3 lg:px-5 lg:pl-3'>
            <div className='flex items-center justify-between'>
                <div className='flex items-center justify-start trl:justify-end'>
                    <button data-drawer-target='logo-sidebar' data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" className="inline-flex items-center p-2 text-sm text-gray-400 rounded-lg  hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-600 ">
            ...
            <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
               <path clip-rule="evenodd" fill-rule="evenodd" d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z"></path>
                    ...
                    <a href='#' className='flex ms-2 md:me-24'>
                        ...
                        <span className='self-center text-xl font-semibold sm:text-2xl whitespace-nowrap text-light'>Flowbite</span>  
                    </a>
                </div>
                ...
                <img class="w-8 h-8 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="user photo"/>
                        ...
                        <div className='z-50 hidden my-4 text-base list-none bg-gray-700 divide-y divide-gray-600 rounded shadow' id='dropdown-user'>
                            <div className='px-4 py-3' role='none'>
                                <p className='text-sm text-light' role='none'>
                                    Neil Sims
                                </p>
                                <p className='text-sm text-gray-300 font-medium truncate' role='none'>
                                    neil.sims@flowbite.com
                                </p>
                            </div>
                            <ul class="py-1" role="none">
                <li>
                  <a href="#" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-600 hover:text-light" role="menuitem">Dashboard</a>
                </li>
                <li>
                  <a href="#" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-600 hover:text-light" role="menuitem">Settings</a>
                </li>
                <li>
                  <a href="#" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-600 hover:text-light" role="menuitem">Earnings</a>
                </li>
                <li>
        ...
        <div className='h-full px-3 pb-4 overflow-y-auto bf-gray800'>
            <ul className='space-y-2 font-medium'>
               ...
               <span className="flex-1 ms-3 whitespace-nowrap">Products</span>
                ...
                <li>
                <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg text-light hover:bg-gray-700 group">
    ...
    <div className='p-4 sm:ml-64'>
        <div className='p-4 border-2 border-gray-700 border-dashed rounded-lg mt-10'>
